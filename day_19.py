...
# but once you've configured it with a blueprint, you can't change it. You'll need to work out which blueprint is best.
...
# so you shouldn't take too long; you need to figure out which blueprint would maximize the number of opened 
...
# number with the largest number of geodes that can be opened in 24 minutes using that blueprint. In this example, 
# the first blueprint has ID 1 and can open 9 geodes, so its quality level is 9. The second blueprint has ID 2 and can open 12 geodes, 
# so its quality level is 24. Finally, if you add up the quality levels of all of the blueprints in the list, you get 33.
...
def run():
    input_data_sample = read_input('./day_19_input_sample.txt')
    input_data = read_input('./day_19_input.txt')
    ...
    # print(f'What do you get if you add up the quality level of all of the blueprints in your list? : {answer_1}') # 
