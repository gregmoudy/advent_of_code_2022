...
# the bottom downward-moving blizzard has been replaced with a new downward-moving blizzard at the top of the valley instead:
...
# On each minute, you can move up, down, left, or right, or you can wait in place. You and the blizzards act simultaneously, 
...
def run():
    data_sample = read_input('./day_24_input_sample.txt')
    data = read_input('./day_24_input.txt')
